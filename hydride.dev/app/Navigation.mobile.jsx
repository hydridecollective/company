...
import { Links } from "./Navigation.client.jsx";
...
export const MobileNavigation = () => {
    ...
    return (
        <>
            <button className={`${isOpen && "hidden"} ${(!isOpen && !isParentOpen) && "md:hidden flex"} flex-row items-center gap-x-2 p-2 rounded-xl hover:bg-neutral-800`} onClick={() => setIsParentOpen(true)}>
...
export const CloseNavigationButton = ({ isOpen, setIsOpen }) => {
    return (
        ...
        >
            <button className={`flex flex-row items-center gap-x-2 p-2 rounded-xl hover:bg-neutral-800 z-[5]`} onClick={() => setIsOpen(false)}>
