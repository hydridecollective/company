...
export const Navigation = ({ params }) => {
    ...
    return (
        <div className={`fixed flex flex-row items-center justify-between gap-x-2 w-full p-4 py-2 md:px-24 2xl:px-96 z-[1] ${pathname === "/" ? "bg-black bg-opacity-[0.075]" : "bg-transparent"}`}>
