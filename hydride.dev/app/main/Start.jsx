...
export const Start = () => {
    ...
    useEffect(() => {
        if (window && window.fpPage !== undefined) {
            if (window.fpPage === 0) {
                setActive(true);
            } else {
                setActive(false);
    ...
    return (
        <Page page={1}>
            <section className="flex flex-col gap-y-4 w-full h-full p-8 pt-32 md:pl-12 items-center text-center">
                <Transition
                    show={active}
                ...
                >
                    ...
                    <div className="mockup-code bg-neutral-800 text-primary-content text-left mt-8 max-w-[32rem] w-full drop-shadow-2xl">
